...
const games = [
  ...
  { id: 'verse-match', name: 'Verse Memory Match', subject: 'Scripture', ages: '4-10', icon: Cross, color: '#5D4037', description: 'Match scripture references to their verses. Coming soon.' },
